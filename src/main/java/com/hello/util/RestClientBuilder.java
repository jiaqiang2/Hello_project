...
public class RestClientBuilder { 
    ...
    * @throws RestClientException RestClient异常，包含状态码和非200的返回内容
    */
   public static <T> T exchange(String url, HttpMethod method, Object body, Class<T> responseType) throws RestClientException {
       return exchange(url, method, null, body, responseType, null);
   }
   ...
   public static <T> T exchange(String url, HttpMethod method, HttpHeaders httpHeaders, Object body, Class<T> responseType, Object... uriVariables) throws RestClientException {
       try {
           ...
           return getClient().exchange(url, method, requestEntity, responseType).getBody();
       } catch (Exception e) {
